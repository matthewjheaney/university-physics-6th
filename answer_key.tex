...
The effect is probably exaggerated in this case, since on a wet, smooth bathtub surface the coefficient of kinetic friction is 
likely to be small compared to the coefficient of static friction.
...
and so the chalk decelerates.
Perhaps it stops, so you push a little more to overcome the static friction, and now the chalk zooms again.  
And so on.
